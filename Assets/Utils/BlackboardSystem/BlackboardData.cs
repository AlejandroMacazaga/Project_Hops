...
namespace Utils.BlackboardSystem
{
    ...
    public class BlackboardData : ScriptableObject
    {
        ...
        public void SetValuesOnBlackboard(Blackboard blackboard)
        {
            ...
            {
                entry.SetOnBlackboard(blackboard);
            }
        }
    }
    ...
    public class BlackboardEntryData : ISerializationCallbackReceiver
    {
        ...
        public void SetOnBlackboard(Blackboard blackboard)
        {
    ...
    public struct AnyValue
    {
        ...
        T ConvertValue<T>()
        {
            return type switch
            {
                ...
                _ => throw new NotSupportedException($"Not supported type: {typeof(T)}")
            };
        }
